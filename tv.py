...
while True:
    ...
    for (startX, startY, endX, endY) in boxes:
        ...
        cv2.putText(orig, textRecognized, (endX + 2, endY + 5), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 0, 255), 3)
    ...
    if key == ord("q"):
        ...
        for (startX, startY, endX, endY) in boxes:
            ...
            # textRecognized = "".join([c if ord(c) < 128 else "" for c in textRecognized]).strip()
            textTranslate = translator.translate(textRecognized, src='en', dest=Translate_to)
            ...
            print("OCR TEXT")
            print("========")
            print("{}\n".format(textRecognized))

            print("{}\n" f'source: {textTranslate.src}')
